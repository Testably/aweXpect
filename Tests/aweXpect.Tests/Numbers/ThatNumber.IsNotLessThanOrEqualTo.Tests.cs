	...
	public sealed class IsNotLessThanOrEqualTo
	{
		public sealed class Tests
		{
			...
			public async Task ForDouble_WhenSubjectIsNaN_ShouldSucceed()
			{
				...
				async Task Act() => await That(subject).IsNotLessThanOrEqualTo(unexpected);
		...
		public sealed class WithinTests
		{
			...
			{
				async Task Act()
					=> await That(double.NaN).IsNotLessThanOrEqualTo(10.0).Within(0.5);
			...
			{
				async Task Act()
					=> await That(5.0).IsNotLessThanOrEqualTo(double.NaN).Within(1.0);
