...
/// <summary>
///     The result of the expectations appended by <paramref name="appendExpectation" />, which were not applied, because
///     the member has a different runtime type than the narrowed type they are written for.
/// </summary>
/// <remarks>
///     It stays <see cref="Outcome.Undecided" />, so that the expectation which narrowed the type reports the mismatch
///     on its own.
/// </remarks>
internal sealed class NotApplicableConstraintResult(Action<StringBuilder, string?> appendExpectation)
	: ConstraintResult(FurtherProcessingStrategy.Continue)
{
	...
	public override void AppendExpectation(StringBuilder stringBuilder, string? indentation = null)
		=> appendExpectation(stringBuilder, indentation);
