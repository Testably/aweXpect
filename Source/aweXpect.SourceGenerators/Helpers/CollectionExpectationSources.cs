...
internal static class CollectionExpectationSources
{
	public const string Attribute =
		...
		internal class CreateCollectionExpectationAttribute : System.Attribute
		{
			...
			/// expected one, and binds the type parameters the parameter names, in order. A helper whose only parameters
			/// besides the subject are a filled one and the negation flag takes no expected value. A nullable first type
			/// argument additionally yields an overload taking a non-nullable expected collection.
			/// </summary>
